...
import {
  ...
  defaultI18n as defaultFormDepositI18n
} from './index'
  ...
  play: async ({ step }) => {
    await step(
      ...
      async ({ canvasElement, args }) => {
        ...
        const totalPlayerReachInput = canvas.getByPlaceholderText(
          args.i18n?.placeholder.totalPlayerReach || '0'
        )
...
export const ERC721: Story = {
  ...
  play: async ({ step }) => {
    await step(
      'Expect From Input to have value',
      async ({ args, canvasElement }) => {
        const canvas = within(canvasElement)
        const fromInput = canvas.getByPlaceholderText(
          args.i18n?.placeholder.tokenFrom || '0'
        )
    ...
    await step(
      ...
      async ({ args, canvasElement }) => {
        const canvas = within(canvasElement)
        const toInput = canvas.getByPlaceholderText(
          args.i18n?.placeholder.tokenTo || '0'
        )
    ...
    await step(
      ...
      async ({ args, canvasElement }) => {
        const canvas = within(canvasElement)
        const tokenIdInput = canvas.getByPlaceholderText(
          args.i18n?.placeholder.tokenId || '0'
        )
    ...
    await step(
      'Form submit should be called',
      async ({ args, canvasElement }) => {
        const canvas = within(canvasElement)
        const button = canvas.getByRole('button', {
          name: args.i18n?.callToActionAddToken
        })
    ...
    await step(
      'Should have total current Token Ids',
      async ({ args, canvasElement }) => {
        const canvas = within(canvasElement)
        const counterText = canvas.getByText(
          `${args.i18n?.addedTokenCounterText} ${args.tokenIdsList.length}`
        )
    ...
    await step(
      'Should have collapse Ids from `tokenIdsList`',
      async ({ args, canvasElement }) => {
        const canvas = within(canvasElement)
...
export const ERC721DisabledAddTokenId: Story = {
  ...
  play: async ({ step }) => {
    await step(
      'Form submit should not be called',
      async ({ canvasElement, args }) => {
        const canvas = within(canvasElement)
        const button = canvas.getByRole('button', {
          name: args.i18n?.callToActionAddToken
...
export const ERC1155: Story = {
  ...
  play: async ({ step }) => {
    await step(
      'Expect Token Id: Gold Input to have value',
      async ({ canvasElement, args }) => {
        const canvas = within(canvasElement)
        const tokenIdGoldInput = canvas.getByPlaceholderText(
          args.i18n?.placeholder.tokenIdGold || '0'
        )
    ...
    await step(
      'Expect Token Id: Silver Input to have value',
      async ({ canvasElement, args }) => {
        const canvas = within(canvasElement)
        const tokenIdSilverInput = canvas.getByPlaceholderText(
          args.i18n?.placeholder.tokenIdSilver || '0'
        )
    ...
    await step(
      'Expect Total Player Reach: Gold Input to have value',
      async ({ canvasElement, args }) => {
        const canvas = within(canvasElement)
        const totalPlayerReachGoldInput = canvas.getByPlaceholderText(
          args.i18n?.placeholder.totalPlayerReachGold || '0'
        )
    ...
    await step(
      'Expect Total Player Reach: Silver Input to have value',
      async ({ canvasElement, args }) => {
        const canvas = within(canvasElement)
        const totalPlayerReachSilverInput = canvas.getByPlaceholderText(
          args.i18n?.placeholder.totalPlayerReachSilver || '0'
        )
